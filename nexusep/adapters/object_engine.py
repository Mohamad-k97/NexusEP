...
class ObjectEngineAdapter:
    ...
    def run_step(self, step_input: SimulationStepInput, *, include_debug: bool = False):
        ...
        object_weather = ObjectWeatherState(
            ...
            north_vertical_radiation_w_m2=weather.north_vertical_radiation_w_m2,
            east_vertical_radiation_w_m2=weather.east_vertical_radiation_w_m2,
            south_vertical_radiation_w_m2=weather.south_vertical_radiation_w_m2,
            west_vertical_radiation_w_m2=weather.west_vertical_radiation_w_m2,
