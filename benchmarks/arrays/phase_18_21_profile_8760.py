...
Run:
    python -m benchmarks.arrays.phase_18_21_profile_8760

Outputs:

    artifacts/profiles/phase18_21/abbey_8760_logs_on_profile.txt
    artifacts/profiles/phase18_21/abbey_8760_logs_on_profile.csv
    artifacts/profiles/phase18_21/abbey_8760_logs_off_profile.txt
    artifacts/profiles/phase18_21/abbey_8760_logs_off_profile.csv
"""
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "artifacts" / "profiles" / "phase18_21"
OUTPUT_DIR = Path(
    os.environ.get("NEXUSEP_PROFILE_OUTPUT_DIR", str(DEFAULT_OUTPUT_DIR))
).resolve()
TOP_N = 80
