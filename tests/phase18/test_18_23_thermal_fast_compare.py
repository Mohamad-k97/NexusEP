...
Run:
    python -m pytest tests/phase18/test_18_23_thermal_fast_compare.py

Provenance:
    adapted from Phase 18.23 content found under the overwritten Phase 17.3
...
def test_fast_thermal_kernel_matches_reference():
