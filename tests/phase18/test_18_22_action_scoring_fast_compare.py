...
Run:
    python -m pytest tests/phase18/test_18_22_action_scoring_fast_compare.py

Provenance:
    adapted from Phase 18.22 content found under the overwritten Phase 17.6
...
def test_fast_action_scoring_matches_reference():
